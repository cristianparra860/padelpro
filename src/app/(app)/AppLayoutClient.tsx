            ...
            {pathname === '/dashboard' ? (
              ...
              <>
                <button
                  ...
                  className="flex items-center gap-2 bg-gray-100 px-6 py-2.5 rounded-full text-gray-900 font-medium active:opacity-70 transition-colors hover:bg-gray-200"
                >
