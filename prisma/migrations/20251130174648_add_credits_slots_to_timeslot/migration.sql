...
INSERT INTO "new_TimeSlot" ("category", "clubId", "courtId", "courtNumber", "courtRentalPrice", "createdAt", "end", "genderCategory", "hasRecycledSlots", "id", "instructorId", "instructorPrice", "level", "levelRange", "maxPlayers", "start", "totalPrice", "updatedAt") SELECT "category", "clubId", "courtId", "courtNumber", "courtRentalPrice", "createdAt", "end", "genderCategory", "hasRecycledSlots", "id", "instructorId", "instructorPrice", "level", "levelRange", "maxPlayers", "start", "totalPrice", "updatedAt" FROM "TimeSlot";
DROP TABLE "TimeSlot";
