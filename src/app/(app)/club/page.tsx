...
export default function ClubProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 pl-16 md:pl-20 lg:pl-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <a 
            href="/clases"
            className="group relative bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 rounded-2xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
          >
            <div className="flex flex-col items-center text-white">
              <div className="bg-white/20 rounded-full p-6 mb-4 group-hover:bg-white/30 transition-colors">
                <GraduationCap className="w-12 h-12" />
              </div>
              <h3 className="text-2xl font-bold mb-2">Clases</h3>
              <p className="text-white/90 text-center text-sm">Reserva tu clase de pádel</p>
            </div>
          </a>
          ...
          <a 
            href="/club-calendar"
            className="group relative bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-2xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
          >
            <div className="flex flex-col items-center text-white">
              <div className="bg-white/20 rounded-full p-6 mb-4 group-hover:bg-white/30 transition-colors">
              ...
              <p className="text-white/90 text-center text-sm">Ver horarios disponibles</p>
            </div>
          </a>
          ...
          <a 
            href="/agenda"
            className="group relative bg-gradient-to-br from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 rounded-2xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
          >
            <div className="flex flex-col items-center text-white">
              <div className="bg-white/20 rounded-full p-6 mb-4 group-hover:bg-white/30 transition-colors">
                <ClipboardList className="w-12 h-12" />
              </div>
              <h3 className="text-2xl font-bold mb-2">Mis Reservas</h3>
              <p className="text-white/90 text-center text-sm">Gestiona tus reservas</p>
            </div>
          </a>
          ...
          <a 
            href="/agenda"
            className="group relative bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 rounded-2xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
          >
            <div className="flex flex-col items-center text-white">
              <div className="bg-white/20 rounded-full p-6 mb-4 group-hover:bg-white/30 transition-colors">
                <Users className="w-12 h-12" />
              </div>
              <h3 className="text-2xl font-bold mb-2">Inscripciones</h3>
              <p className="text-white/90 text-center text-sm">Inscríbete en eventos</p>
            </div>
          </a>
        </div>
      </div>
